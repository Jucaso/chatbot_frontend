...
const RecomendacionLibro4 = (props) => {
...
<div className="options-container">
  <button key={1} onClick={props.actionProvider.handleLinkOPACLibro4} className="option-button">
  {"Encuéntralo aquí"}
  </button>
  <button key={2} onClick={props.actionProvider.handleRecomendacionLibro4} className="option-button">
...
export default RecomendacionLibro4;