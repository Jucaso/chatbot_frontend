...
const RecomendacionLibro3 = (props) => {
...
<div className="options-container">
  <button key={1} onClick={props.actionProvider.handleLinkOPACLibro3} className="option-button">
  {"Encuéntralo aquí"}
  </button>
  <button key={2} onClick={props.actionProvider.handleRecomendacionLibro3} className="option-button">
...
export default RecomendacionLibro3;