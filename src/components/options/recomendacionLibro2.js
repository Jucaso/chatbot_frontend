...
const RecomendacionLibro2 = (props) => {
...
<div className="options-container">
  <button key={1} onClick={props.actionProvider.handleLinkOPACLibro2} className="option-button">
  {"Encuéntralo aquí"}
  </button>
  <button key={2} onClick={props.actionProvider.handleRecomendacionLibro2} className="option-button">
...
export default RecomendacionLibro2;